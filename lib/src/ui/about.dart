                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Image.asset("assets/images/iso.png",
                                  fit: BoxFit.fitWidth),
                              Padding(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  ...
                                  child: RichText(
                                      text: TextSpan(
                                          text:
                                              "Para incluir su propiedad (casa, terreno o apartamento) en el sitio web de HogarEnCuba solo debe enviarnos los datos de la misma al correo electronico: ",
                                ...
                                child: Html(
                                  data: """
                                    <ul>
                                      ...
                                      <li>Teléfonos del propietario</li>
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                IconButton(
                                    ...
                                    onPressed: () async {
                                      if (await canLaunch("tel:+5358074332")) {
                                        await launch("tel:+5358074332");
                                      }
                                    }),
                                IconButton(
                                    icon: Icon(
                                    ...
                                    onPressed: () async {
                                      if (await canLaunch(
                                        ...
                                        await launch("mailto:info@daxslab.com");
                                      }
                                    }),
                                IconButton(
                                    icon: Icon(
                                    ...
                                    onPressed: () async {
                                      if (await canLaunch(
                                          "https://t.me/daxslab")) {
                                        await launch("https://t.me/daxslab");
                                      } else {
                                        await launch("https://t.me/daxslab");
                                      }
                                    }),
                                IconButton(
                                    ...
                                    onPressed: () async {
                                      if (await canLaunch(
                                          "https://m.me/daxslab")) {
                                        await launch("https://m.me/daxslab");
                                      } else if (await canLaunch(
                                          "https://fb.me/daxslab")) {
                                        await launch("https://fb.me/daxslab");
                                      } else {
                                        await launch(
