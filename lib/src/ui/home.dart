...
class HomeState extends State<Home> {
  ...
  final Map<String, dynamic> location = {
    ...
    "Isla de la Juventud": ["--Cualquiera--", "Nueva gerona"]
  };
                    ...
                    builder: (context, AsyncSnapshot<Response> snapshot) {
                      if (snapshot.hasData) {
                        ...
                        List<HomeEntity> homes =
                            list.map((i) => HomeEntity.fromJson(i)).toList();

                        if (this.province != null) {
                          homes = homes
                              .where((home) =>
                                  home.location.trim().endsWith(this.province))
                              .toList();
                        }
                        ...
                        if (this.city != null) {
                          homes = homes
                              .where((home) =>
                                  home.location.trim().startsWith(this.city))
                              .toList();
                        }

                        if (this.type != null) {
                          homes = homes
                              .where((home) => home.type.trim() == this.type)
                              .toList();
                        }

                        if (this.minPrice != null) {
                          homes = homes
                              .where((home) => home.price >= this.minPrice)
                              .toList();
                        }

                        if (this.maxPrice != null) {
                          homes = homes
                              .where((home) => home.price <= this.maxPrice)
                              .toList();
                        }
                        ...
                        if (this.bedrooms != null) {
                          homes = homes
                              .where(
                                  (home) => home.bedroomsCount == this.bedrooms)
                              .toList();
                        }
                        ...
                        if (this.bathrooms != null) {
                          homes = homes
                              .where((home) =>
                                  home.bathroomsCount == this.bathrooms)
                              .toList();
                        }
                        ...
                        if (homes.isNotEmpty) {
                          WidgetsBinding.instance.addPostFrameCallback((_) {
                            if (ModalRoute.of(context).isCurrent) {
                              Toast.show(
                                  isFiltered
                                      ? "${homes.length} resultados para su búsqueda."
                                      : "${homes.length} propiedades en oferta.",
                                  context,
                        ...
                        return FutureBuilder(
                          ...
                          builder: (BuildContext context, snapshot) {
                            if (snapshot.data == true) {
                              List<dynamic> list = storage.getItem("data");

                              if (list != null) {
                                List<HomeEntity> homes = list
                                    .map((i) => HomeEntity.fromJson(i))
                                    .toList();

                                if (this.province != null) {
                                  homes = homes
                                      .where((home) => home.location
                                          .trim()
                                          .endsWith(this.province))
                                      .toList();
                                }
                                ...
                                if (this.bedrooms != null) {
                                  homes = homes
                                      .where((home) =>
                                          home.bedroomsCount == this.bedrooms)
                                      .toList();
                                }
    ...
    showGeneralDialog(
        ...
        pageBuilder: (BuildContext context, __, ___) {
          return WillPopScope(
              ...
              }, child: Modal(child: Scaffold(body: StatefulBuilder(
                                    ...
                                    DropdownButton(
                                      ...
                                      onChanged: (newValue) {
                                        setState(() {
                                          ...
                                          cityValue = "--Cualquiera--";
                                          if (newValue != "--Cualquiera--") {
                                            cities = location[newValue]
                                                as List<String>;
                                          }
                                        });
                                      },
                                      items: privinces.map((type) {
  ...
  void close() {
    setState(() {
      ...
      this.cityValue = (this.city != null) ? this.city : "--Cualquiera--";
      this.typeValue = (this.type != null) ? this.type : "--Cualquiera--";
      ...
      this.bathroomValue = (this.bathrooms != null)
    ...
    return InkWell(
        onTap: () {
          Navigator.of(context)
              .pushNamed(HomeDetails.routeName, arguments: data);
        },
        child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              Expanded(
                                child: Text("${data.code}: ${data.title}",
                                    softWrap: true,
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 18,
          ...
          Column(
            ...
            children: <Widget>[
              Padding(
                  ...
                  child: Text("Compruebe su conexión de red.")),
              RaisedButton(
                child: Text(
                  "Reintentar",
                  style: TextStyle(color: Colors.white),
